...
use opencv::core::{
    CommandLineParser, Point, Point2f, Rect2f, Size, StsBadArg, StsError, TickMeter,
};
use opencv::objdetect::{FaceRecognizerSF, FaceRecognizerSF_DisType};
use opencv::prelude::*;
use opencv::{
    Error, Result, core, highgui, imgcodecs, imgproc, not_opencv_branch_34, objdetect,
    opencv_branch_34, videoio,
};
use std::env;
use std::path::Path;
...
fn main() -> Result<()> {
    let fd_model_path =
        r"D:\RustRoverProjects\rust-vision\models\face_detection_yunet_2023mar.onnx";
    let fr_model_path =
        r"D:\RustRoverProjects\rust-vision\models\face_recognition_sface_2021dec.onnx";
    ...
    let input1 = "assets/test/img_2.png";
    ...
    let input2 = "assets/test/img_5.png";
